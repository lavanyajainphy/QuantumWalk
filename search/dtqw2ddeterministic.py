...
def qw2d(n, L, marked, tau, label, reset=None, r=None, radius=None, coin=None):
    ...
    # Probability that detection has NOT happened yet
    survival_prob = 1.0
    ...
    for t in range(n):
        ...
        if (t + 1) % tau == 0:
            ...
            marked_probs = np.array([
                prob[m] for m in marked_idx
            ])
            ...
            # =========================================
            # EXACT FIRST DETECTION PROBABILITY
            # =========================================

            Fn[attempt - 1] = (
                survival_prob * total_marked_prob
            )
            ...
            elif reset == "Most Probable Position":
